...
import { Building2, Trash2, Users, Calendar } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            <strong>⚠️ Attention :</strong> La suppression d'une société est irréversible et supprime toutes les données associées (articles, ventes, achats, factures, etc.).
          </p>
        </div>
      </div>
    </div>
