...
export function ContactForm({ contact, type, onSubmit, onCancel, loading = false }: ContactFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex space-x-4 pt-4">
            ...
            <button 
              type="button"
              onClick={onCancel} 
              className="flex-1 bg-gray-200 text-gray-800 py-2 rounded-lg hover:bg-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
              disabled={loading}
            >
              Annuler
            </button>
